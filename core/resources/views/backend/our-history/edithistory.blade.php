        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    <form role="form" action="{{route('update.history', $history->id)}}" method="post" novalidate enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('put')}}
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                <label for="form_control_1"><b>Title</b></label>
                                <input type="text" name="history_title" class="form-control" id="history_title" value="{{$history->title}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="history_text" style="width: 100% !important; display: inherit;"
                                          id="history_text" rows="8" maxlength="350">{{$history->text}}</textarea>
                            </div>
                        </div>
                        <div class="row">
