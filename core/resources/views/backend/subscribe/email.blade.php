...
@section('addNewButon')
    <a class="btn blue btn-outline btn-lg sbold pull-right topModalbtn" href="{{route('subscribers')}}"> Back </a>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    <form role="form" action="{{route('subs.mail')}}" method="post" novalidate>
                        {{csrf_field()}}
                        <div class="form-body">
